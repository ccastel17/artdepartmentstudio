...
console.log('✓ Generating mock data and images...');
...
for (const section of sections) {
  ...
  for (let i = 0; i < templates.length; i++) {
    ...
    const project = {
      ...
      // Add price per day for rental items
      ...(section === 'rental' && { pricePerDay: Math.floor(Math.random() * 150) + 50 }) // Random price between 50-200€
    };

    allProjects[section].push(project);
  }
...
fs.writeFileSync(dataPath, JSON.stringify(allProjects, null, 2));

console.log('\n✅ Successfully generated 60 projects across 6 sections');
console.log('✅ Generated SVG placeholder images');
console.log('✅ Saved projects data to data/projects.json');
